"""
Django settings for recipenewpy project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'tranquil-journey-26821-bbf38fa9f3ee.herokuapp.com']
...
WSGI_APPLICATION = 'recipenewpy.wsgi.application'
